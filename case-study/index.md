...
![A photo of an A4 paper with flowchat for an app drawn on it](img/app-wireframe-paper.png)
![A vector of the basicest value proposition graphic one will ever see. All of the text inside the shapes is in czech, but putting all the translations here would be torture for the both of us](img/app-value-proposition.png)
