...
![A photo of an A4 paper with 4 versions of posible site layout](img/site-layout-paper-2)
![A photo of an A4 paper with site layout](img/site-layout-paper-1)
...
![A photo of an A4 paper with flowchat for an app drawn on it](img/app-wireframe-paper)
![A vector of the basicest value proposition graphic one will ever see. All of the text inside the shapes is in czech, but putting all the translations here would be torture for the both of us](img/app-value-proposition)
![An image with coloured squares divided into two a vertical rows. First row has 4 squares in these colours: Red (#E80000), Darker red (#900000), White (#FFFFFF) and Black (#000000). The text beside it translates into: Main colours. The second row has 5 smaller squares in colours: Various shades of darkening red (#962222), (#791C1C), (#5D1515), (#451F1E). The last square is Bright green (#00E80F). The text beside it translates into: Secondary colours.](img/app-color-palette)
![An image with various styles of poppins font](img/app-poppins)
![An image with various styles of ITC Berkley font](img/app-berkley)
